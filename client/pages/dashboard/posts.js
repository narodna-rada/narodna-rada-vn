...
Template.postsList.events({
	...
	if (template.find('#picture')) options.picture=template.find('#picture').value;
...
Template.buttonsEditDelete.events({
	...
	if (location.pathname==='/dashboard/postsEdit') {
		...
		$('.imgForPost').html('<img src="'+postToEdit.picture+'" class="img-rounded" width="150"><input type="hidden" id="picture" value="'+postToEdit.picture+'">');
